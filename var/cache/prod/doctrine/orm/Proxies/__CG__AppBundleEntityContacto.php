...
class Contacto extends \AppBundle\Entity\Contacto implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Contacto' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Contacto' . "\0" . 'telefono', '' . "\0" . 'AppBundle\\Entity\\Contacto' . "\0" . 'facebook', '' . "\0" . 'AppBundle\\Entity\\Contacto' . "\0" . 'twitter', '' . "\0" . 'AppBundle\\Entity\\Contacto' . "\0" . 'instagram', '' . "\0" . 'AppBundle\\Entity\\Contacto' . "\0" . 'linkedin', '' . "\0" . 'AppBundle\\Entity\\Contacto' . "\0" . 'google', '' . "\0" . 'AppBundle\\Entity\\Contacto' . "\0" . 'youtube'];
        }
