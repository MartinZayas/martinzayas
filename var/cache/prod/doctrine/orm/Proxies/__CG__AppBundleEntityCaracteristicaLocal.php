 ...
 */
class CaracteristicaLocal extends \AppBundle\Entity\CaracteristicaLocal implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\CaracteristicaLocal' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\CaracteristicaLocal' . "\0" . 'nombre', '' . "\0" . 'AppBundle\\Entity\\CaracteristicaLocal' . "\0" . 'slug', '' . "\0" . 'AppBundle\\Entity\\CaracteristicaLocal' . "\0" . 'localid'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CaracteristicaLocal $proxy) {
