...
/* eventos/paso2.html.twig */
class __TwigTemplate_941eb2e49764005fdbd1e4da692952727e877a5327a387ba42d91f6d14871781 extends Twig_Template
{
    public function __construct(Twig_Environment $env)
    {
        ...
        // line 2
        $this->parent = $this->loadTemplate("eventos/paso1.html.twig", "eventos/paso2.html.twig", 2);
        $this->blocks = array(
...
";
    ...
    public function block_headerParallax($context, array $blocks = array())
    {
        // line 166
        echo "    ";
        $this->loadTemplate("default/subheader.html.twig", "eventos/paso2.html.twig", 166)->display(array_merge($context, array("bgImage" => (        // line 167
($context["directorio_imagenes_public"] ?? null) . "backgrounds/bg3.jpg"), "subheaderTitle" => "PROPONER CONCIERTO: Paso 2")));
    ...
    public function block_steps($context, array $blocks = array())
    {
        // line 172
        echo "    ";
        $this->loadTemplate("default/steps.html.twig", "eventos/paso2.html.twig", 172)->display(array_merge($context, array("titles" => array(0 => "Información General", 1 => "¿Dónde?", 2 => "¿Cuándo?", 3 => "Entradas"))));
    }
    ...
    public function block_customContent($context, array $blocks = array())
    {
                        ...
                        <div class=\"panel-body\">
                            ...
                            <div class=\"row mb5\">
                                <div class=\"col-sx-6 col-sm-6 col-md-6 col-lg-6\">
                                    <input type=\"text\" class=\"form-control tNombre\" id=\"nombre\" name=\"nombre\" placeholder=\"Nombre del local &oacute; sala\">
                                </div><!-- Fin del nombre -->
                                <div class=\"col-sx-6 col-sm-6 col-md-6 col-lg-6\">
                            ...
                            <div class=\"row mb5\"><!-- Fila 3 -->
                                <div class=\"col-sx-6 col-sm-6 col-md-6 col-lg-6\">
                                    <label class=\"etiqueta\" for=\"precio\">Rango de Precios:</label>
                                </div>
                                <div class=\"col-sx-6 col-sm-6 col-md-6 col-lg-6\">
                                    <label class=\"etiqueta\" for=\"aforo\">Aforo:</label>
                                </div>
                            </div><!-- Fin Fila 3-->
                            <div class=\"row mb10\"><!-- fila 4 -->
                                <div class=\"col-sx-6 col-sm-6 col-md-6 col-lg-6\">
                                    <div class=\"slidecontainer\">
                                        <input type=\"range\" min=\"1\" max=\"1000\" value=\"1\" class=\"slider\" id=\"precio\">                            
                                    </div>
                                </div>
                                <div class=\"col-sx-6 col-sm-6 col-md-6 col-lg-6\">
                                    <div class=\"slidecontainer\">
                                        <input type=\"range\" min=\"1\" max=\"2000\" value=\"1\" class=\"slider\" id=\"aforo\">                            
                                    </div>
                                </div>
                            </div><!-- Fin Fila 3-->
                            <div class=\"row mb10\"><!-- fila 4 -->
                                ...
                                <div class=\"col-sx-6 col-sm-6 col-md-6 col-lg-6\">
                                    <div class=\"col-xs-3 col-sm-3 col-md-3 col-lg-3 desde\">0</div>
                                    <div class=\"col-xs-4 col-sm-4 col-md-4 col-lg-4\"></div>
                                    <div class=\"col-xs-5 col-sm-5 col-md-5 col-lg-5 hasta\">2000</div>
                                </div>
                            </div><!-- Fin fila 4 -->
                            <div class=\"row mb5\"><!-- Fila 5 -->
                                ...
                                <div class=\"col-sx-12 col-sm-12 col-md-2 col-lg-2\">
                                    <buttom type=\"reset\" name=\"cancelar\" class=\"btn btn-info btn-block\" id=\"cancelar\" data-toggle=\"tooltip\" title=\"Borrar los par&aacute;metros del filtro\">
                                        Cancelar
                                    </buttom>
                                </div>
                                <div class=\"col-sx-12 col-sm-12 col-md-2 col-lg-2\">
                                    <buttom type=\"submit\" name=\"aceptar\" class=\"btn btn-primary btn-block\" id=\"aceptar\" data-toggle=\"tooltip\" title=\"Aplicar el filtro\">
                                        Aplicar
                                    </buttom>
                                </div>
                                <div class=\"hidden-xs hidden-sm col-md-4 col-lg-4\"></div>
        ...
        <div id=\"step-1-container\" class=\"row background-white mb40 pt20 pb20\">
            <div class=\"col-sm-12\">
                <div class=\"panel no-margin panel-primary\">
                    <div class=\"panel-heading\">
                        <strong>Establece el local</strong>
                    </div>
                                ...
                                <div class=\"col-sm-6\"><!-- Locales -->
                                    <div class=\"row\">
                                        <div class=\"col-xs-12 col-sm-12 col-md-12 col-lg-12\">
                                            <div id=\"etiquetaLocal\" class=\"etiqueta2\">Locales <span class=\"required\">*</span></div>
                                        </div>
                                    </div>
                                    <div class=\"row\">
                                        <div class=\"col-xs-12 col-sm-12 col-md-12 col-lg-12\">
        ...
        echo "\" id=\"btnAdicionarLocal\" class=\"boton btn btn-success btn-block botonAgregar\">
                            ...
                            <div class=\"row mb10\"><!-- Fila 1 -->
                                <div class=\"col-sm-6\"><!-- País -->
                                    <div class=\"row\">
                                        <div class=\"col-xs-12 col-sm-12 col-md-12 col-lg-12\">
                                            <div id=\"etiquetaPais\" class=\"etiqueta2\">Pa&iacute;s <span class=\"required\">*</span></div>
                                        </div>
                                    </div>
                                    <div class=\"row\">
                                        <div class=\"col-xs-12 col-sm-12 col-md-12 col-lg-12\">                                            
                                ...
                                <div class=\"col-sm-6\"><!-- Provincia -->
                                    <div class=\"row\">
                                        <div class=\"col-xs-12 col-sm-12 col-md-12 col-lg-12\">
                                            <div id=\"etiquetaProvincia\" class=\"etiqueta2\">Provincia <span class=\"required\">*</span></div>
                                        </div>
                                    </div>
                                    <div class=\"row\">
                                        <div class=\"col-xs-12 col-sm-12 col-md-12 col-lg-12\">                                            
                            ...
                            <div class=\"row mb10\"><!-- Fila 2 -->
                                <div class=\"col-sm-6\"><!-- Ciudad -->
                                    <div class=\"row\">
                                        <div class=\"col-xs-12 col-sm-12 col-md-12 col-lg-12\">
                                            <div id=\"etiquetaCiudad\" class=\"etiqueta2\">Ciudad <span class=\"required\">*</span></div>
                                        </div>
                                    </div>
                                    <div class=\"row\">
                                        <div class=\"col-xs-12 col-sm-12 col-md-12 col-lg-12\">                                            
                                ...
                                <div class=\"col-sm-6\"><!-- Direccion -->
                                    <div class=\"row\">
                                        <div class=\"col-xs-12 col-sm-12 col-md-12 col-lg-12\">
                                            <div id=\"etiquetaDireccion\" class=\"etiqueta2\">Direcci&oacute;n <span class=\"required\">*</span></div>
                                        </div>
                                    </div>
                                    <div class=\"row\">
                                        <div class=\"col-xs-12 col-sm-12 col-md-12 col-lg-12\">                                            
        ...
        echo "\" class=\"btn btn-rw btn-primary tags btn-block siguiente\" id=\"anterior1\" data-toggle=\"tooltip\" title=\"Anterior - Informaci&oacute;n General\">
        ...
        echo "\" class=\"btn btn-rw btn-primary tags btn-block siguiente\" id=\"siguiente2\" data-toggle=\"tooltip\" title=\"Siguiente - Fecha y hora\">
                                        Siguiente
...
";
    ...
    {
        return "eventos/paso2.html.twig";
    }
    ...
    {
        return array (  638 => 525,  634 => 524,  629 => 522,  619 => 516,  616 => 515,  599 => 502,  590 => 496,  522 => 431,  506 => 417,  503 => 416,  492 => 414,  487 => 413,  485 => 412,  251 => 180,  248 => 179,  243 => 172,  240 => 171,  236 => 167,  234 => 166,  231 => 165,  225 => 163,  73 => 14,  69 => 13,  65 => 12,  61 => 11,  56 => 9,  51 => 7,  47 => 6,  42 => 5,  39 => 4,  33 => 3,  11 => 2,);
    }
    ...
    {
        return new Twig_Source("", "eventos/paso2.html.twig", "/var/www/html/agenciaeventos/app/Resources/views/eventos/paso2.html.twig");
    }
}
