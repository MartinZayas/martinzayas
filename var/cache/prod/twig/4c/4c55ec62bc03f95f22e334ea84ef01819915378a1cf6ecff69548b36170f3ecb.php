...
/* eventos/paso1.html.twig */
class __TwigTemplate_99c5078daf84ee72255f9f957dd92df3bcef47245b3096182441ea95153e2249 extends Twig_Template
{
    public function __construct(Twig_Environment $env)
    {
        ...
        // line 2
        $this->parent = $this->loadTemplate("default/formatoBase.html.twig", "eventos/paso1.html.twig", 2);
        $this->blocks = array(
...
";
    ...
    public function block_headerParallax($context, array $blocks = array())
    {
        // line 96
        echo "    ";
        $this->loadTemplate("default/subheader.html.twig", "eventos/paso1.html.twig", 96)->display(array_merge($context, array("bgImage" => (        // line 97
($context["directorio_imagenes_public"] ?? null) . "backgrounds/bg3.jpg"), "subheaderTitle" => "PROPONER CONCIERTO: Paso 1")));
    }
    ...
    public function block_steps($context, array $blocks = array())
    {
        // line 102
        echo "    ";
        $this->loadTemplate("default/steps.html.twig", "eventos/paso1.html.twig", 102)->display(array_merge($context, array("titles" => array(0 => "Información General", 1 => "¿Dónde?", 2 => "¿Cuándo?", 3 => "Entradas"))));
    }
    ...
    public function block_customContent($context, array $blocks = array())
    {
        ...
        echo "                                                </select>
                                            ...
                                            <div class=\"form-group\">
                                                <label>¿No aparece el artista invitado en la lista? Enviale una invitaci&oacute;n a su correo</label>
        ...
        echo "
                            ...
                            <div class=\"row\"><!-- Botones -->
                                ...
                                <div class=\"col-sx-4 col-sm-3 col-md-2 col-lg-2\">
                                    <button type=\"submit\" class=\"btn btn-rw btn-primary tags btn-block siguiente\" id=\"siguiente1\" data-toggle=\"tooltip\" title=\"Siguiente - Local\">
                                        Siguiente
...
";
    ...
    {
        return new Twig_Source("", "eventos/paso1.html.twig", "/var/www/html/agenciaeventos/app/Resources/views/eventos/paso1.html.twig");
    }
}
