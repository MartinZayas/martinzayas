...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct(array $buildParameters = array())
    {
        ...
        $this->normalizedIds = array(
            'appbundle\\controller\\artistascontroller' => 'AppBundle\\Controller\\ArtistasController',
            'appbundle\\controller\\defaultcontroller' => 'AppBundle\\Controller\\DefaultController',
            'appbundle\\controller\\eventocontroller' => 'AppBundle\\Controller\\EventoController',
            'appbundle\\controller\\imagencontrolller' => 'AppBundle\\Controller\\ImagenControlller',
            'appbundle\\controller\\profesionalcontroller' => 'AppBundle\\Controller\\ProfesionalController',
            'appbundle\\controller\\salascontroller' => 'AppBundle\\Controller\\SalasController',
            'appbundle\\controller\\seguridadcontroller' => 'AppBundle\\Controller\\SeguridadController',
        ...
        $this->fileMap = array(
            'AppBundle\\Controller\\ArtistasController' => __DIR__.'/getArtistasControllerService.php',
            'AppBundle\\Controller\\DefaultController' => __DIR__.'/getDefaultControllerService.php',
            'AppBundle\\Controller\\EventoController' => __DIR__.'/getEventoControllerService.php',
            'AppBundle\\Controller\\ImagenControlller' => __DIR__.'/getImagenControlllerService.php',
            'AppBundle\\Controller\\ProfesionalController' => __DIR__.'/getProfesionalControllerService.php',
            'AppBundle\\Controller\\SalasController' => __DIR__.'/getSalasControllerService.php',
            'AppBundle\\Controller\\SeguridadController' => __DIR__.'/getSeguridadControllerService.php',
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('3R7RnXdr7g', 0, ($this->targetDirs[0].'/pools'));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('i2HSzT+vBH', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    protected function getTwigService()
    {
        ...
        $instance->addGlobal('directorio_imagenes_public', 'bundles/app/img/');
        $instance->addGlobal('uploads_images', 'uploads/images/');
        $instance->addGlobal('uploads_events', 'uploads/events/');
        $instance->addGlobal('uploads_images_temp', 'uploads/images/temp/');
        $instance->addGlobal('uploads_images_albums', 'uploads/images/albums/');
        $instance->addGlobal('uploads_images_eventos', 'uploads/images/conciertos/');
        $instance->addGlobal('uploads_music', 'uploads/music/');
        $instance->addGlobal('directorio_imagenes_admin', 'bundles/admin/img/');
    ...
    {
        return $this->services['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('SJjBonT9Wy', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('ubnh4cz8qE', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('bgXkQ8vzLF', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['fragment.listener'] = new \Symfony\Component\HttpKernel\EventListener\FragmentListener(${($_ = isset($this->services['uri_signer']) ? $this->services['uri_signer'] : $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('d72dba6413d359047517686c9e0e3c90b716fdee')) && false ?: '_'}, '/_fragment');
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/vendor/doctrine/doctrine-bundle/Resources/views'), '!Doctrine');
        $instance->addPath(($this->targetDirs[3].'/src/AdministracionBundle/Resources/views'), 'Administracion');
        $instance->addPath(($this->targetDirs[3].'/src/AdministracionBundle/Resources/views'), '!Administracion');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('d72dba6413d359047517686c9e0e3c90b716fdee');
    }
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = array(
                ...
                'AdministracionBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/AdministracionBundle'),
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'AdministracionBundle' => 'AdministracionBundle\\AdministracionBundle',
            ...
            'database_port' => NULL,
            'database_name' => 'buscoconcierto-orm',
            'database_user' => 'root',
            ...
            'secret' => 'd72dba6413d359047517686c9e0e3c90b716fdee',
            'locale' => 'en',
            'fragment.renderer.hinclude.global_template' => '',
            'fragment.path' => '/_fragment',
            'kernel.secret' => 'd72dba6413d359047517686c9e0e3c90b716fdee',
